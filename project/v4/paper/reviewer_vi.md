...
Tài liệu này ghi các vấn đề cần kiểm tra trước khi nộp bản thảo. Trạng thái xử lý được phân biệt giữa thay đổi đã có bằng chứng và thí nghiệm còn cần thực hiện. Ngày: {{DATE}}.
