...
Tài liệu đi cùng bản thảo và app, không phải thư trả lời cho một journal cụ thể. "Đã xử lý" chỉ có nghĩa đã có thay đổi và bằng chứng tương ứng; không có nghĩa rủi ro khoa học đã biến mất. Ngày: {{DATE}}.
