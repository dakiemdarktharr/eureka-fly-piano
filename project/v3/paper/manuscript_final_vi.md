...
Lượt 20260918T043824-s0-5816, seed 0, gồm 24 thế hệ hoàn tất và 172 ứng viên đã đánh giá. Thời gian tối ưu 903.42 s; đánh giá 63.84 s; tổng thời gian 968.80 s; 12,420,000 bước vật lý. Ngân sách 900 s bị vượt nhẹ vì hoàn tất ứng viên đang chạy. Tham số tốt nhất theo train-monitor không đổi từ mốc 5 đến 15 phút; neural mix cuối bằng 0.9226. Tiêu chí 85% chưa đạt.

| Mốc thực (phút) | Bài | Train F1 | Val P | Val R | Val F1 | Đúng / mục tiêu |
|---|---|---|---|---|---|---|
| 0.00 | merry | 0.089 | 0.063 | 0.131 | 0.085 | 13 / 99 |
| 0.00 | pool | 0.074 | 0.093 | 0.172 | 0.121 | 15 / 87 |
| 1.08 | merry | 0.089 | 0.063 | 0.131 | 0.085 | 13 / 99 |
| 1.08 | pool | 0.074 | 0.093 | 0.172 | 0.121 | 15 / 87 |
| 5.00 | merry | 0.188 | 0.109 | 0.212 | 0.144 | 21 / 99 |
| 5.00 | pool | 0.050 | 0.136 | 0.253 | 0.177 | 22 / 87 |
| 15.06 | merry | 0.188 | 0.109 | 0.212 | 0.144 | 21 / 99 |
| 15.06 | pool | 0.050 | 0.136 | 0.253 | 0.177 | 22 / 87 |
...
| Bài | Nốt phát | Đúng | Precision | Recall | F1 | Mục tiêu |
|---|---|---|---|---|---|---|
| merry | 202 | 13 | 0.064 | 0.148 | 0.090 | 88 |
| pool | 156 | 7 | 0.045 | 0.085 | 0.059 | 82 |
...
| Bài / controller | Nốt phát | Đúng | Precision | Recall | F1 | Mục tiêu |
|---|---|---|---|---|---|---|
| merry / trained | 5124 | 376 | 0.073 | 0.157 | 0.100 | 2401 |
| pool / trained | 3632 | 228 | 0.063 | 0.152 | 0.089 | 1502 |
